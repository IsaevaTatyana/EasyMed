...
public class Level2 extends AppCompatActivity {
    ...
    Array2 array = new Array2();  // Создали новый объект из класса Array
...
//        image_right_down.setClipToOutline(true);
        ...
        dialogend2 = new Dialog(this); //create new window
        dialogend2.requestWindowFeature(Window.FEATURE_NO_TITLE); //delete tytle
        dialogend2.setContentView(R.layout.dialogend2);//путь к макету диалогового окна
        dialogend2.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));//прозрачный фон диалог. окна
        dialogend2.setCancelable(false);//нельзя закрыть обычной кнопкой
        ...
        btnclose2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogend2.dismiss(); //close dialog window
            }
        });
