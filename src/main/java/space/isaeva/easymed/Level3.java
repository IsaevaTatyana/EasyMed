...
public class Level3 extends AppCompatActivity {
    ...
    Array4 array = new Array4();  // Создали новый объект из класса Array
...
//        image_right_down.setClipToOutline(true);
        ...
        dialog.setContentView(R.layout.previewdialog3);//путь к макету диалогового окна
        ...
        dialogend.setContentView(R.layout.dialogend3);//путь к макету диалогового окна
