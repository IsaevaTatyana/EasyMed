...
public class Level5 extends AppCompatActivity {
    ...
    Array5 array = new Array5();  // Создали новый объект из класса Array
...
//        image_right_down.setClipToOutline(true);
        ...
        dialog.setContentView(R.layout.previewdialog5);//путь к макету диалогового окна
        ...
        dialogend.setContentView(R.layout.dialogend5);//путь к макету диалогового окна
